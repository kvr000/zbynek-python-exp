...
class RaceCar(Entity):
    ...
    def make_car(self):
        # Body
        Entity(parent=self, model='cube', color=color.azure, scale=(1, 0.3, 3))
        # Nose
        #Entity(parent=self, model='cube', color=color.azure, scale=(0.4, 0.2, 1.2), position=(0, 0, 2))
        ...
        # Driver
        Entity(parent=self, model='sphere', color=color.dark_gray, scale=(0.25, 0.25, 0.25), position=(0, 0.25, 0.15))
